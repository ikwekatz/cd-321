         ...
         <form>
             <div class="form-row profile-row">
                 ...
                 <div class="col-md-8">
                     ...
                     <div class="form-row">
                         <div class="col-sm-12 col-md-6">
                             <div class="form-group"><label>Gender </label><input class="form-control" type="text" name="gender" autocomplete="off" required=""></div>
                         </div>
                         <div class="col-sm-12 col-md-6">
                             <div class="form-group"><label>Country</label><input class="form-control" type="text" name="country" autocomplete="off" required=""></div>
                         </div>
                     </div>
                     <hr>
                     <div class="form-row">
