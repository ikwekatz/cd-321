                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 col-2">
                        <a href="<?php echo $pth;?>" class="brand-wrap">
                            <img class="logo " width="100px" src="<?php echo Image.'favico.ico';?>">
                        </a> <!-- brand-wrap.// -->
                    </div>
                                    ...
                                    <div class="text text-white">
                                        <div class="text text-white">
                                            <a class="text text-white"
                                                href="<?php echo page; ?>public/login.php">Login</a> |
                                            <a class="text text-white" href="<?php echo page; ?>public/register.php">
                                                Register</a>
                                        </div>
                                    </div>
                                </div>
