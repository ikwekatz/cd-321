            ...
            <div class="p-3 py-5">
                ...
                <form class=' form form-inline1' action="#" method="POST" enctype="multipart/form-data">
                    <div class="row mt-2">
                        ...
                        <div class="col-md-3"><input type="text" class="form-control" placeholder="first name"
                                id="fname" value="<?php echo $_SESSION['fname']; ?>" disabled></div>
                        <label for="lname" class="col-form-label">Last Name</label>
                        <div class="col-md-3"><input type="text" class="form-control" id="lname"
                                value="<?php echo $_SESSION['lname']; ?>" disabled></div>
                        <label for="email" class="col-form-label">Email</label>
                        <div class="col-md-3"><input type="text" name="email" id="email" class="form-control"
                                placeholder="Email" value="<?php echo $_SESSION['email']; ?>" disabled></div>
                    </div>
                    <div class="row mt-3">
                        <label for="gender" class="col-form-label">Gender</label>
                        <div class="col-md-4"><input type="text" class="form-control" id="gender"
                                value="<?php echo $_SESSION['gender']; ?>" placeholder="Phone number" disabled></div>
                        <label for="country" class="col-form-label">Country:</label>
                        <div class="col-md-4"><input type="text" class="form-control" id="country" placeholder="country"
                                value="<?php echo $_SESSION['country']; ?>" disabled></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <label for="phone" class="col-form-label">Phone</label>
                            <div class="col-md-4"><input type="text" class="form-control" id="phone"
                                    value="<?php echo $_SESSION['phone']; ?>" placeholder="Phone number" disabled></div>
                        </div>
                        <div class="col-md-4">
                            <?php
                  ...
                  if ($stmt->execute()){
                   ...
                   $job2 .= "</select></div>";
                    ...
                    <div class="custom-file">
                        ...
                        <input type="file" class="custom-file-input" name="fileID" id="customFile" multiple="multiple"
                            required accept=".pdf">
