...
<body>
    <div class="card col-md-8 centbox">
        ...
        <div class="card-body centbox">
            <form class="needs-validation" method="POST" action="<?php echo page;?>procces_log.php">
                <div class="form-row">
                    <div class="col-md-12 mb-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" name="uname" id="validationCustomUsername"
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 mb-3">
                        <h6>Don't have an Acount? <a href="<?php echo page?>public/register.php"><span
                                    class="text-primary">Register</span></a></h6>
                    </div>
                </div>
            </form>
        </div>
